...
#define CMD_ARGS_HAVE_DELAY 0x80 //ST_CMD_DELAY
void initDisplaySpi()
{
	//FIXME: add display init
/*     // NO MISO
...
{
	//FIXME: add display write single byte
...
{
	//NOTE: this is called right before stuff gets printed so it should be initialized by now
