...
// Returns nothing
//
void HUlib_initTextLine(hu_textline_t *t, short x, short y, const patch_t *f, short sc)
...
// Returns nothing
//
void HUlib_initSText(hu_stext_t *s, short x, short y, short h, const patch_t *font, short startchar, boolean *on)
{
