...
// %, : graphics
static const char *percent_name = "WIPCNT";
static const char *colon_name = "WICOLON";

// minus sign
static const char *wiminus_name = "WIMINUS";

// "Finished!" graphics
static const char *finished_name = "WIF";

// "Entering" graphic
static const char *entering_name = "WIENTER";

// "secret"
static const char *sp_secret_name = "WISCRT2";

// "Kills", "Scrt", "Items", "Frags"
static const char *kills_name = "WIOSTK";
static const char *items_name = "WIOSTI";

// Time sucks.
static const char *time1_name = "WITIME";
static const char *par_name = "WIPAR";
static const char *sucks_name = "WISUCKS";

// "Total", your face, your dead face
static const char *total_name = "WIMSTT";
...
static int WI_drawNum(int x, int y, int n, int digits)
{
    ...
    {
        spiFlashSetAddress((uint32_t) &_g->num[0]->width);
        fontwidth = spiFlashGetShort();
    }
    else
    {
#ifdef CONFIG_DOOM_NO_COMPACT_PTR
    ...
    if (neg)
        // CPhipps - patch drawing updated
        V_DrawNumPatch(x -= 8, y, FB, wiminus_lump, CR_DEFAULT, VPT_STRETCH);
...
void WI_drawStats(void)
{
    ...
    {
        spiFlashSetAddress((uint32_t) &_g->num[0]->height);
        lh = (3 * spiFlashGetShort()) / 2;
    }
    else
    {
#ifdef CONFIG_DOOM_NO_COMPACT_PTR
