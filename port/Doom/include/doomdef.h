...
//
#define YCOORD_DATATYPE signed short
...
#define HIGHRES
#ifdef HIGHRES
#define MAX_SCREENWIDTH  (SCREENWIDTH_PHYSICAL)
#else
#define MAX_SCREENWIDTH  (SCREENWIDTH_PHYSICAL/2)
#endif
#define SCREENWIDTH MAX_SCREENWIDTH

#define SCREENHEIGHT MAX_SCREENHEIGHT
#define SCREENPITCH SCREENWIDTH //In pixels.
...
typedef YCOORD_DATATYPE ycoord_t;   //
// phares 3/20/98:
//
