...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DMA_LOG_LEVEL_INF, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SPI_ESP32_INTERRUPT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CFB_LOG_LEVEL_INF, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BUILD_OUTPUT_INFO_HEADER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BUILD_OUTPUT_META, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BUILD_OUTPUT_META_STATE_PROPAGATE, 1);
